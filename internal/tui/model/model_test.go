...
func (t *testRegistry) ListCommandSets(ctx context.Context) ([]adapters.CommandSetSummary, error) {
	return t.items, nil
}
...
func (t *testRegistry) SaveCommandSet(ctx context.Context, cs adapters.CommandSetSummary) error {
	return nil
}
...
func (t *testRegistry) ReplaceCommands(ctx context.Context, name string, commands []string) error {
	return nil
}
...
func (t *testExecutor) Run(ctx context.Context, name string, commands []string) (adapters.RunHandle, error) {

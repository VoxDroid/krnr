...
Thank you for contributing to krnr! Please complete this template to help us review your changes efficiently. Ensure your submission complies with our Contributing Guidelines, Code of Conduct, and Security Policy. Do not include unverified links or promotional content, as they will be considered spam.
...
- \[ \] My changes are formatted (`gofmt`/`gofumpt`) and linted.
- \[ \] I have run unit tests locally (`go test ./...`).
- \[ \] I have updated the documentation (e.g., `README.md`, `SUPPORT.md`, `docs/`) if necessary.
- \[ \] My changes do not introduce new dependencies without prior discussion.
- \[ \] My changes respect intellectual property rights and applicable laws.
